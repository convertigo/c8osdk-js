...
- [Documentation](#documentation-1)
        - [Creating a C8o instance](#creating-a-c8o-instance-1)
        - [Advanced instance settings](#advanced-instance-settings-1)
        - [Calling a Convertigo requestable with call parameters](#calling-a-convertigo-requestable-with-call-parameters)
- [Full documentation is available on](#full-documentation-is-available-on)
    ...
    - [Full documentation is available on](#full-documentation-is-available-on-1)
...
This current package is the Javascript SDK. For others SDKs see official [Convertigo Documentation.](https://www.convertigo.com/document/all/cmp-7/7-5-1/reference-manual/convertigo-mbaas-server/convertigo-client-sdk/programming-guide/)
...
The project name is optional, i.e. if not<p align="center">
  <img src="https://www.convertigo.com/wp-content/themes/EightDegree/images/logo_convertigo.png">
  <h2 align="center"> C8oSDK Javascript</h2>
</p>
<p align="center">
...
[Programming Guide](https://www.convertigo.com/document/convertigo-client-sdk/programming-guide/)
 specified, the project specified in the endpoint will be used.
